...
export class UserdetailComponent implements OnInit{
  ...
  private loadMap(coordinate: Coordinate): void {
    ...
    var map = Leaflet.map('map').setView([coordinate.latitude, coordinate.longitude], 8);
    ...
    Leaflet.marker([coordinate.latitude, coordinate.longitude], {icon: this.marker}).addTo(map)
